...
$route[$home . "([a-zA-Z0-9]+)"] = "$1/index/?page=$2";
$route[$home . "([a-zA-Z0-9]+)/page_([0-9]*?){$config['suffix']}"] = "$1/index/?page=$2";
$route[$home . "([a-zA-Z0-9]+)/([0-9]*?){$config['suffix']}"] = "$1/index/?id=$2&bh1=$3&bh2=$4&bh2=$5&order=$6&carname=$7";

$route[preg_replace("/[\/]$/", "", $home_m)] = "Layout_m/index";
//$route[$home_m . "car/"] = "Car_m/index";
$route[$home_m . "([a-zA-Z0-9]+)"] = "$1_m/index/?page=$2";
$route[$home_m . "([a-zA-Z0-9]+)/page_([0-9]*?){$config['suffix']}"] = "$1_m/index/?page=$2";
//$route[$home_m . "([a-zA-Z0-9]+)/page_([0-9]*?){$config['suffix']}"] = "Channel_m/index/?dir=$1&page=$2";
$route[$home_m . "([a-zA-Z0-9]+)/([0-9]*?){$config['suffix']}"] = "$1_m/index/?dir=$1&id=$2";
